...
<body>
	...
	<div class="container">
		...
		<h3>${orderResult }</h3>
		<!--     테스트값입니다. -->
		<div><input type="button" onclick="javascript:jsf__pay();" value="카카오 결제창 호출"></div>
	</div>

	<script type="text/javascript" src="https://testpay.kcp.co.kr/plugin/payplus_web.jsp"></script>
		
	<form name="kcp_order_info" id="kcp_order_info" action="/kakaoPay" method="post" accept-charset="euc-kr">
